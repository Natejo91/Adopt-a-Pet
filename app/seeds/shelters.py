...
def seed_shelters():
    ...
    while i < len(shelterIds) -1:
        response = requests.get(f'https://api.petfinder.com/v2/organizations/{shelterIds[i]}', auth=BearerAuth('eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..EV3RAdzR_HNUpkfbRbzZSMJGB9G4vF1q_fUEOjY10XMtp0vol3vRQhqTd_rIfBCiiKJJYXxA9g8u6rHFXbPmHi1XOW9shB0ruAD-VaTN_IZ_zgQwGDqFkeVGjFcySqkhTzkRD9EaQMADnaHA_etD7kmK2HAxOAKK9bpapUYVcSv0Rs_NfVij3mDJhoLPTbS2rxhmDRTTX6v4qhnde0te-abNYQ8prXoGdjkOg0KFO_OCL1dE3qSLzE_k-NdcLyAoz2daa4D8tOt9W2EolbrsiMKVu8_FyUkjuwXxBxvZExdVSXOVqQJwr_0V3l8a5MJbvTJupbmfpLJomigyxGKfsw')).json()
