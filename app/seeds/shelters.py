...
def seed_shelters():
    ...
    while i < len(shelterIds) -1:
        ...
        response = requests.get(f'https://api.petfinder.com/v2/organizations/{shelterIds[i]}', auth=BearerAuth('eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..Hw5OVsn94TaHn0jQCS50AeSdXFv5U5s-XYmS8SolYjz0EjyGbJPxZvVb6HLRNWzTgbvQUBVYdY0ABC3ZkQcziMrZiQI60gxo4kFGFceWsLTCYMQHwkhQY0ierphZ9ldZeGmVyjX3rtDtOWrgSIyze0x76dIzLOZvg_LLAJWAue1Wr0konec9d4RlVq7ZuEyokmGdqBBud1M5e5_uXd_ie8h5ivJBHQqWy1M-EqsuC1sQwGlOm7AyU44ABlfEgyBNY4cMYY8ZuGxSAw1XOF8oabb87POLoQF4imZ6D_Oy-8x3KZYuuvgG2OURivCR086gzhsHeEDH6wYVjDvmR71ixw')).json()
