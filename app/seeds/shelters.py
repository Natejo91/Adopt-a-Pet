...
def seed_shelters():
    ...
    while i < len(shelterIds) -1:
        response = requests.get(f'https://api.petfinder.com/v2/organizations/{shelterIds[i]}', auth=BearerAuth('eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..WCo9zcmtQh9sLWWWdPo-utJWJd1a55YOjkUBvDgCzNcUYKOzbdbtETiPZLH59qSnLQiw_LY7Fu1Oa4RcIJzIRginzeIdLpPm5luLR8uPo5hhONMqEBix4Cpjt-fRNyS4gC2HoVbDu2W-fiOY9lR-2Qdg2SM6OU5McnFiI-ZKYbLJHjf0fxNLVGXdXSY1Gp5zNH0QZnXUfDZVds3qfUfr8CUvt1ymrOHb56ik3_ErmDD4o-G2EPba0R4NIIl50H9EmUiGjmFGhXDH_dGulWdeAbNoFppEbuiSpO3ZVnfdQbRopUYHsrAcnsz5tSIYTspPR7K_x0NorQ36VMTEDg1mAg')).json()
