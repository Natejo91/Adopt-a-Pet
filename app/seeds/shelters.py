...
def seed_shelters():
    ...
    while i < len(shelterIds) -1:
        ...
        response = requests.get(f'https://api.petfinder.com/v2/organizations/{shelterIds[i]}', auth=BearerAuth('eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..tnCqQvO-TKpBJJ-qx7kg9kmztQaBeZglO3rl0M7arfwiwWp1dNV_NAUESE_Tp_7ZWyfh0FM22II5-e6ZIbX209x5VDsvLnJnM_1Zw6kTKJD_jxLXupFdaEh6aln5995KQsO1gpz2lLZjkuDmGEdPGs0yilAQxGWCJ9nkDzOTVlrWDYumbEGzzO1zS1Pnka2SsvqinG8XxDH_O8pVaP70HetA4AAujZCYn9ylz7RiLh9v0Xcp4NlENFay42ElSKJ8uklgfUzDFoY0280LDMV3pS-bNxf-HhiHs83mcv79nmaAW-oez8uZWu1FPYR9BPkBAfMe2BVMy0apuTO9NSdnwg')).json()
