...
def seed_shelters():
    ...
    while i < len(shelterIds) -1:
        ...
        response = requests.get(f'https://api.petfinder.com/v2/organizations/{shelterIds[i]}', auth=BearerAuth('eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..nAJJoGRbqwTA7rnZ8o4lhOrCk0X9TPZ6Rrey9YS2ZUAD-KblgzfChF5jCFoA_mnOpg86XvjU146uYvtJdJB2SnpaYtUAtV2Wk7K3Fei6riFXgfUL38aD2-Nzy9tGQRFWh1fUI_TslXDDhhw-vAN_im2JSyjF7VIgJQQ_av5IXJMTa6vP7EVkh8XxUwP9gRu2LHM8VW4pyhGK_9HAit_MGrV9fFns7zCxX539WlWGMmFFqRYPElNtYL91NGaBJJNv2EAK_rlsH11YAOb8kR5J8Ud2Mdpop4Nsye2S3KegGqLgAD-zmTE1I1EKk-1_OYQ1VOb_TTNCDNR1MeB_c5mrsg')).json()
